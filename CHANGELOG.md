...
- Unit tests that were failing the CI pipelines have been removed to finally
  return to a stable build.
...
- A virtual gamepad touch controls for mobile devices such as phones and tablets has
  been implemented and enabled.
...
- The Desktop apps are now based on Electron v28.2.0.
  As always, a new Electron runtime should offer improved performance, security and
  bug fixes, that may or may not be visible or even useful to end users.
